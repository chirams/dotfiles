...
DOT_HOME=`pwd`/files
DOT_FILES=( .vimrc .bashrc .bash_profile .screenrc .gitconfig .gitignore .inputrc .colorrc .editrc .gitattributes_global .tmux.conf)
VIM_DIRS=( after/ftplugin dict syntax dein.rc tmp template )
LOCAL_DIRS=( bin submodule/git/contrib/completion )
MODE=0
